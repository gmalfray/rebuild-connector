...
- **Contrôle de type redondant** : n’ajoutez pas de `is_string()`/`is_int()` lorsque la variable est déjà typée ou castée ; PHPStan remontera une alerte `function.alreadyNarrowedType`.
