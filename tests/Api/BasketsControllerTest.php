...
final class BasketsControllerTest extends TestCase
{
    ...
    {
        $controller = new TestBasketsController();
...
final class TestBasketsController extends RebuildconnectorBasketsModuleFrontController
{
